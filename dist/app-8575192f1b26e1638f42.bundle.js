...
document.body.appendChild(loginContainer); // global value that holds info about the current hand.

var currentGame = null; // create game btn
...
var runGame = function runGame(_ref) {
  ...
  for (var i = 0; i < flashCards.length; i += 1) {
