...
loginBtn.addEventListener('click', function () {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default().post('/login', loginData).then(function (response) {
    ...
    if (response.data.error) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get('/user').then(function (response1) {
        console.log(response1.data);
        userDiv.innerText = response1.data.user.name;
      })["catch"](function (error) {
